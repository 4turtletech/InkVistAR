const DEFAULT_COMMISSION_RATE = 0.60;
...
function normalizeCommissionSplit(value) {
...
function artistCommission(appointment, artistId) {
...
module.exports = { DEFAULT_COMMISSION_RATE, resolveCommissionRate, normalizeCommissionSplit, artistCommission };
