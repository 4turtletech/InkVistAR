...
const styles = StyleSheet.create({
  ...
  content: { padding: 20 },
  statusCard: { backgroundColor: '#1f2937', padding: 20, borderRadius: 12, marginBottom: 15 },
  statusHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 10 },
  statusTitle: { color: '#9ca3af', marginLeft: 10, fontSize: 16 },
  ...
  logItem: { flexDirection: 'row', marginBottom: 15, borderBottomWidth: 1, borderBottomColor: '#374151', paddingBottom: 10 },
  logTime: { color: '#9ca3af', width: 80, fontSize: 12 },
  logMessage: { color: 'white', flex: 1, fontSize: 14 }
});