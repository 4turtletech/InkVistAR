...
import {
  View, Text, StyleSheet, TouchableOpacity, FlatList, SafeAreaView, ScrollView, Animated, PanResponder, Dimensions, LayoutAnimation, Platform, TextInput
} from 'react-native';
import { LinearGradient } from 'expo-linear-gradient';
import {
  ArrowLeft, Bell, Calendar, CheckCircle, XCircle, Star,
  CreditCard, Info, MessageSquare, Mail, MailOpen, ChevronDown, Trash2, Filter, Search, X
...
export function CustomerNotifications({ onBack, userId }) {
  ...
  const renderItem = ({ item, index }) => (
    <SwipeableNotificationItem
      item={item} index={index} onPress={onPress} onToggleRead={onToggleRead} onDismiss={onDismiss} theme={theme} styles={styles}
    />
  );
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.searchBar}>
        ...
        <TextInput
          ...
          accessibilityLabel="Search customer notifications"
        />
        {!!search && (
...
const getStyles = (theme) => StyleSheet.create({
  ...
  readBg: { position: 'absolute', left: 0, right: 0, top: 0, bottom: 0, backgroundColor: theme.gold, borderRadius: borderRadius.xl, justifyContent: 'center', alignItems: 'flex-start', paddingLeft: 24 },
  deleteBg: { position: 'absolute', left: 0, right: 0, top: 0, bottom: 0, backgroundColor: theme.error, borderRadius: borderRadius.xl, justifyContent: 'center', alignItems: 'flex-end', paddingRight: 24 },
  ...
  card: {
    ...
    borderWidth: 1, borderColor: theme.border, borderLeftWidth: 3, ...shadows.subtle
  },
  cardUnread: { borderLeftColor: theme.gold },
