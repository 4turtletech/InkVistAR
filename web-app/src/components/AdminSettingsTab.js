                    ...
                    {activeTab === 'policies' && (
                        <div className="settings-panel">
                            ...
                            <div className="settings-section">
                                ...
                                <div className="form-group" style={{marginTop: '20px'}}>
                                    <label>Service Waiver Clauses (One per line)</label>
                                    <textarea
                                        value={settings.policies.waiverClauses || ''}
                                        onChange={(e) => handleChangeWithValidation('policies', 'waiverClauses', e.target.value)}
                                        className="form-input"
                                        rows="10"
                                    />
                                    <small style={{color: '#64748b', marginTop: '4px', display: 'block'}}>These will be displayed as a numbered list on the Terms & Conditions page.</small>
                                </div>
                                <div className="form-group" style={{marginTop: '20px'}}>
                                    <label style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
                                        <span>Dynamic Policy Sections</span>
                                        <button 
                                            type="button" 
                                            onClick={() => {
                                                const newSections = [...(settings.policies.policySections || [])];
                                                newSections.push({title: 'New Section', content: 'Section details...'});
                                                handleChangeWithValidation('policies', 'policySections', newSections);
                                            }}
                                            style={{background: 'rgba(190, 144, 85, 0.1)', color: '#be9055', border: '1px solid #be9055', borderRadius: '4px', padding: '4px 8px', cursor: 'pointer', fontSize: '0.8rem', fontWeight: 'bold'}}
                                        >
                                            + Add Section
                                        </button>
                                    </label>
                                    {(settings.policies.policySections || []).map((section, idx) => (
                                        <div key={idx} style={{background: 'rgba(0,0,0,0.02)', padding: '16px', borderRadius: '8px', marginBottom: '12px', border: '1px solid #e2e8f0'}}>
                                            <div style={{display: 'flex', justifyContent: 'space-between', marginBottom: '8px'}}>
                                                <input 
                                                    ...
                                                    className="form-input"
                                                    style={{fontWeight: 'bold', width: '85%'}}
                                            ...
                                            <textarea 
                                                ...
                                                className="form-input"
                                                rows="4"
                                                placeholder="Section content (One bullet point per line)"
                                            />
                                        </div>
                                    ))}
                                </div>
